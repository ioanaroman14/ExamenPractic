...
public class Console {
    private MasinaService medicineService;
    private InchiriereService cardClientService;
    private TransactionService transactionService;

    private Scanner scanner;

    public Console (MasinaService medicineService, InchiriereService cardClientService, TransactionService transactionService){
    ...
    private void showMenu() {
        System.out.println("1. Masina CRUD");
    ...
    private void runCardClientsSearch(){
        ...
        for (Inchiriere c : cardClientService.fullTextSearch(text)){
    ...
    private void handleViewCardClients(){
        for (Inchiriere cardClient : cardClientService.getAll()){
    ...
    private void handleViewMedicine() {
        for (Masina medicine : medicineService.getAll()) {
    ...
    private void handleRemoveMedicine()throws CustomException {
        try {
            ...
            System.out.println("Masina removed!");
        } catch (Exception ex) {
            System.out.println("Errors:\n" + ex.getMessage());
        }
    }
    private void handleAddUpdateMedicine() throws CustomException {
        try {
            ...
            System.out.println("Masina added!");
        } catch (Exception ex) {
            System.out.println("Errors:\n" +  ex.getMessage());
        }
    }
